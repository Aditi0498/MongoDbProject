...
const { getAllIssuedBooks } = require("../controllers/book-controller");
const { getAllUsers, getSingleUserById, deleteUsers, updateUserById, createNewUser } = require("../controllers/user-controller");
